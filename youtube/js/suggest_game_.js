(() => {
  ...
  // TEST REV17: Keep the Suggest close button inside iOS's visible viewport when the keyboard opens.
  ...
  // TEST REV17: Suggest closes deliberately via the persistent X (or Escape), not by clicking the backdrop.
