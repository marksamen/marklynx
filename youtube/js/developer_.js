(() => {
  ...
  // TEST REV22: iOS hides native horizontal scrollbars after interaction.
  // Use a small always-visible mobile indicator instead and keep it synced to the card rail.
  ...
  if (developerCards) {
    ...
    developerCards.insertAdjacentElement('afterend', indicator);
