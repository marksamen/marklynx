(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/main_test.html?v=20260915-stats3', 'mainModuleMount');
      await loadHtml('sections/recent_test.html?v=20260915-stats3', 'recentModuleMount');
      await loadHtml('sections/footer_test.html?v=20260915-stats3', 'footerModuleMount');
      ...
      const statsResponse = await fetch('data/stats.json?v=20260915-stats3', { cache: 'no-store' });
      ...
      await loadScript('js/youtube_modular_test.js?v=20260915-stats3');
      await loadScript('js/site_modular_test.js?v=20260915-stats3');
      await loadScript('js/recent_modular_test.js?v=20260915-stats3');
    } catch (error) {
