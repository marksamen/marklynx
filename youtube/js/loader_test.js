(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/main_test.html?v=20260915-stats2', 'mainModuleMount');
      await loadHtml('sections/recent_test.html?v=20260915-stats2', 'recentModuleMount');
      await loadHtml('sections/footer_test.html?v=20260915-stats2', 'footerModuleMount');
      ...
      const statsResponse = await fetch('data/stats.json?v=20260915-stats2', { cache: 'no-store' });
      ...
      await loadScript('js/youtube_modular_test.js?v=20260915-stats2');
      await loadScript('js/site_modular_test.js?v=20260915-stats2');
      await loadScript('js/recent_modular_test.js?v=20260915-stats2');
    } catch (error) {
