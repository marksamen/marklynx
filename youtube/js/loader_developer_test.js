(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/main_developer_test.html?v=20260915-devtest2', 'mainModuleMount');
      await loadHtml('sections/recent.html?v=20260915-prod1', 'recentModuleMount');
      await loadHtml('sections/developer_test.html?v=20260915-devtest2', 'developerModuleMount');
      ...
      await loadScript('js/youtube.js?v=20260915-prod1');
      await loadScript('js/site.js?v=20260915-prod1');
      await loadScript('js/recent.js?v=20260915-prod1');
      await loadScript('js/developer_test.js?v=20260915-devtest2');
    } catch (error) {
