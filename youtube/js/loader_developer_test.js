(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/main_developer_test.html?v=20260915-devtest1', 'mainModuleMount');
      await loadHtml('sections/recent.html?v=20260915-prod1', 'recentModuleMount');
      await loadHtml('sections/developer_test.html?v=20260915-devtest1', 'developerModuleMount');
      ...
      await loadScript('js/developer_test.js?v=20260915-devtest1');
    } catch (error) {
