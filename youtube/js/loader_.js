(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/recent_.html?v=20260921-matching-headers-REV04', 'recentModuleMount');
      ...
      await loadScript('js/site_.js?v=20260921-matching-headers-REV04');
