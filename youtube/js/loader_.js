(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/main_.html?v=20260921-game-guides-copy-spacing-REV11', 'mainModuleMount');
      ...
      await loadScript('js/site_.js?v=20260921-game-guides-copy-spacing-REV11');
