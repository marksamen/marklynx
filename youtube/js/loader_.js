(() => {
  ...
  (async () => {
    try {
      ...
      await loadHtml('sections/main_.html?v=20260921-game-guides-container-REV09', 'mainModuleMount');
      ...
      await loadScript('js/site_.js?v=20260921-game-guides-container-REV09');
